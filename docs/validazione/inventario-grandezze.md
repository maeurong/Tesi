...
- gravità e materiale — **superato il 08/09/2026**: il deck nudo non scrive la
  gravità e non porta un materiale, e la costante GRAVITY_MM_S2, AnalysisConfig
  e Material sono usciti dalla configurazione con essi (vedi ADR). Le due prove
  di gravità e la coerenza ρ·V·g → N misuravano il solutore integrato, che è
  uscito con la mappa #161: non c'è più una grandezza da convertire qui, e le
  prove escono con lei.
...
| O4 — GRAVITY_MM_S2 che nessun test asserisce | **superata il 08/09/2026**: il deck nudo non scrive la gravità e la costante è uscita dalla configurazione (vedi ADR). Chiusa era (`aa2716f`); le due prove escono con la costante | — |
