...
### UV\_INSECURE\_NO\_ZIP\_VALIDATION
...
### UV\_INSTALLER\_GITHUB\_BASE\_URL
...
### UV\_NO\_INSTALLER\_METADATA

added in `0.5.7`

Skip writing `uv` installer metadata files (e.g., `INSTALLER`, `REQUESTED`, and `direct_url.json`) to site-packages `.dist-info` directories.

### UV\_NO\_INSTALL\_LOCAL
...
### UV\_PYTHON\_DOWNLOADS

added in `0.3.2`

Equivalent to the [`python-downloads`](https://docs.astral.sh/uv/reference/settings/#python-downloads) setting and, when disabled, the `--no-python-downloads` option. Whether uv should allow Python downloads.

### UV\_PYTHON\_DOWNLOADS\_JSON\_URL
...
### UV\_SKIP\_WHEEL\_FILENAME\_CHECK
...
### UV\_TEST\_NO\_HTTP\_RETRY\_DELAY
...
See [https://doc.rust-lang.org/std/env/fn.current\_exe.html#security](https://doc.rust-lang.org/std/env/fn.current_exe.html#security) for security considerations.
