...
This is to inform you about the new stable release of [Nuitka](https://nuitka.net/). It is the extremely compatible Python compiler, [“download now”](https://nuitka.net/doc/download.html).
