...
- Write a short paper in Markdown format using `paper.md` as file name, including a title, summary, author names, affiliations, and key references. See our [example paper](example_paper.html) to follow the correct format.
...
- Waiting for the managing editor to start a pre-review issue over in the JOSS reviews repository: [https://github.com/openjournals/joss-reviews](https://github.com/openjournals/joss-reviews)
...
Please write [admin@theoj.org](mailto:admin%40theoj.org) with confidential matters such as retraction requests, report of misconduct, and retroactive author name changes.
