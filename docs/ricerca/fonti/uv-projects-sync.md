...
> [!important] Important
> On-sync malware checking is in [preview](https://docs.astral.sh/uv/concepts/preview/), and is subject to change until stabilized.
