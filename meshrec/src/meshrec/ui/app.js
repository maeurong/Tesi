...
const ETICHETTE_DEI_BLOCCHI = { input: "lettura", segment: "segmentazione", downsample: "riduzione", normals: "normali", surface: "superficie", repair: "riparazione", simplify: "semplificazione", tet: "tetraedri", export: "esportazione", analysis: "analisi", regioni: "regioni", wall: "prior geometrico" };
